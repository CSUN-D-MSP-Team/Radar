...
speed_on = 'OS'
speed_off =  'Os'
speed_on1 = 'O2'        #multi objects from 1-9 
...
range_on = 'OD'
range_off = 'Od'
range_on1  = 'o2'     # multi object from 1-9 
...
overflow_watchdog = 'OZ'     #USB port for LInux 
...
ser = serial.Serial(
    ...
    baudrate = 9600,                           #default baud rate for radar
...
send_serial_cmd(overflow_watchdog)
